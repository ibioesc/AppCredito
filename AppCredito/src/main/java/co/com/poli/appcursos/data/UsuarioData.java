...
public class UsuarioData {
    ...
    static{
        ...
        listaUsuarios = new ArrayList<Usuario>(){
            {
          //      add(new Usuario("10", "Maria", "1000", "INDEPENDIENTE" , "VIVIENDA","SI");
          //                          , "12345", "ADMIN", Boolean.TRUE));
          //      add(new Usuario("20", "Jorge", "Medina", "jorgem@gmail.com" 
          //                          , "12345", "CONSULTA", Boolean.TRUE));   
          //      add(new Usuario("30", "ibio", "escobar", "ibio@gmail.com" 
          //                          , "12345", "CONSULTA", Boolean.TRUE));  
            }
        };
    }
    
    public UsuarioData(String Documento, String Nombre, String Monto_aprestar, String Tipo_trabajadores, String Tipo_credtio, String Trabaja_compañia) {
