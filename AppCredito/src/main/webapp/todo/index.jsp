            ...
            <div class="jumbotron">
                <div class="container">
                    <form method="post"
                        ...
                        <div class="form-row">
                            <div class="col">
                                <input name="txtMonto" type="monto" 
                                       class="form-control" 
                                       placeholder="monto">
                            </div>
                            <div class="form-row">
                                <select name="txtTipo_trabajo" type="password" 
                                       class="form-control" 
                                       <option value="Trabajo"selected>Independiente</option> 
                                    <option value="Trabajo"selected>dependiente</option> 
                                       placeholder="Clave">
                                </select>
                            </div>                           
                        </div>   
                        <div class="form-row">
                            <div class="col">
                                <select name="txtTipo_credito" id="inputState" 
                                        class="form-control">
                            ...
                            <div class="col">
                                <select name="txtTrabajo_compañia" id="inputState" 
                                        class="form-control">
                        ...
                        <div class="form-row">
                            <div class="col">
                              ...
                              <div class="col">
                                <button name="accion" value="actializar" type="submit" 
                                        class="btn btn-primary">
                                    actualizar
                                </button>
                            </div>  
